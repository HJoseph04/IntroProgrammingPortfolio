...
When the program runs through an array like this, it usually uses nested loops: the outer loop (i) moves through each row, and the inner loop moves across the columns in that row. Sounds familiar? 
