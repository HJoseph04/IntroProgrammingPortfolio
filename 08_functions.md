...
Functions can also take parameters, which are like inputs that let you customize what the function does each time you call it, think of it as customizing how your Mii looks like for a Nintendo console. 
...
returntype FunctionName (insert parameters)
{
    // function body: code 
